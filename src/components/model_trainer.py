...
class ModelTrainer:
    ...
    def get_model_object_and_report(self,train:np.array,test:np.array) -> Tuple[object,object]:
        ...
        """
        try:
            logging.info("Started training the model using RandomForestClassifier with specified parameters")
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        ...
        try:
            ...
            logging.info(f"Model trained with following metrics: {metric_artifact}")

            preprocessing_obj=load_object(file_path=self.data_tanformation_artifact.transformed_object_file_path)
            ...
            logging.info("Model found with expected accuracy, hence saving the model")
