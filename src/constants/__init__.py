...
"""
DATA_INGESTION_COLLECTION_NAME: str = "Insurance_Prediction"
...
MODEL_TRAINER_TRAINED_MODEL_PARMS_FILE: str = "model_params.yaml"
...
MODEL_BUCKET_NAME = "my-model-mlopsprojt"
